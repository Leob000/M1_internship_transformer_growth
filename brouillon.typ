...
// TODO: Separate the problem in two
We then have
$
...
#remark[
  ...
  $
    limits(W'_Q)_(d_e times ( d_k+p )) =mat(
      delim: "[", augment: #3,
      w_1, ..., w_k, bold(0)_1, ..., bold(0)_p;
    ) \
    limits(diff W'_Q)_(d_e times ( d_k+p )) =mat(
      delim: "[", augment: #3,
      diff w_1, ..., diff w_k, bold(0)_1, ..., bold(0)_p;
    ) \
    limits(W^("new")_Q)_(d_e times ( d_k+p )) =mat(
      delim: "[", augment: #3,
...
$
  ...
  V_X mat(underbrace(I_r, r times r), 0; 0, underbrace(0, (e-r)times(e-r))) V_X^top
  W_Q W_K^top
  V_X mat(underbrace(I_r, r times r), 0; 0, underbrace(0, (e-r)times(e-r))) V_X^top .
$
#proof[
  ...
  $
    ...
    mat(underbrace(Sigma_r, r times r), 0; 0, underbrace(0, (s-r) times(e-r))) =
    mat(underbrace(I_r, r times r), 0; 0, underbrace(0, (e-r) times(e-r)))
  $
]
